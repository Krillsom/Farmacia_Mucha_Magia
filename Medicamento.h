...
public:
	...
	Medicamento(T1 nombre, T2 cantidad, T3 precio, string categoria, short vecesVendido);
	~Medicamento();
...
struct Medicamento<T1, T2, T3>::MedicamentoStruct {
	...
	MedicamentoStruct(char* _nombre, int _cantidad, float _precio, char* categoria, short vecesVendido = 0) {
...
template<typename T1, typename T2, typename T3>
inline Medicamento<T1, T2, T3>::Medicamento(T1 nombre, T2 cantidad, T3 precio, string categoria, short vecesVendido)
{
	this->nombre = nombre;
	this->cantidad = cantidad;
	this->precio = precio;
